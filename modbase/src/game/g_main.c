...
#ifndef FINAL_BUILD
	{ &g_saberDebugPrint, "g_saberDebugPrint", "0", 0, qfalse  }, //kaldor - removing cheat
#endif
...
#ifdef DEBUG_SABER_BOX
	{ &g_saberDebugBox, "g_saberDebugBox", "0", 0, qfalse }, //kaldor - unsure what this will do. Gonna try it out.
#endif
...
// nmckenzie: DUEL_HEALTH: Default.
	...
	G_LoadArenas(); // sil - fix for map voting with bot_enable 0
